...
C-----CALCULATE BOUNDARY GRID SIZES AND ORIENTATIONS
 ...
 100  FORMAT(4I5)
      ...
      SUBROUTINE WALLFN(IE,YP,YP1,DK1,DE1,DEN1,SINX1,SINY1,
     1     SINZ1,F1,AN1,SU1,SP1,
     2     TAUN1,YPLN1,GEN1,VISE1,
     3     U1,V1,W1,U0,V0,
     4     W0,U2,V2,W2,
     5     SUK1,SPK1,ANV2,ANW2,TJ01)
      COMMON
     1   /PRCP/ VISE(21,18,10),DEN(21,18,10),VISC,DENIN,FLOWIN,
     1   /TUR/ SIGK,SIGE,CMU,C1,C2,CMU1,CMU2,E,CK,HINUM,SMNUM,ANV1(800),
     2     YN(800),YN1(800),SINX(800),SINY(800),SINZ(800),ANW1(800),
     3     YPLN(800),TAUN(800),IBC(800),JBC(800),KBC(800),IITY(800),
     4     TALW(800),GEN(21,18,10),MC(21,18,10),IJL0(21,18,10),IIT0
C-----WALL FUNCTION USING LOGARITHMIC WALL LAW
      GO TO (1,2,3,4,5,6,7), IE
      RETURN
 1    CONTINUE
C-----U
      SQRTK=SQRT(DK1)
      YPLN1=DEN1*SQRTK*CMU1*YP/VISC
      IF(YPLN1 .LE. 11.63) GO TO 111
      TMULT=VISC/YP
      TMULT=DEN1*CMU1*SQRTK*CK/ALOG(E*YPLN1)
      GO TO 112
 111  TMULT=VISC/YP
 112  TAUN1=-TMULT
      PTA=TJ01*SINX1*TMULT/YP1
      SP1=SP1-PTA
      SU1=SU1+PTA*F1
      P1=SQRT(1.-SINX1**2)
      ANV1=AN1*SQRT(1.-SINY1**2)
      ANW1=AN1*SQRT(1.-SINZ1**2)
      AN1=P1*AN1
      RETURN
 2    CONTINUE
C-----V
      TMULT=-TAUN1
      PTA=TJ01*SINY1*TMULT/YP1
      SP1=SP1-PTA
      SU1=SU1+PTA*F1
      AN1=ANV2
      RETURN
...
C-----K
      SQRTK=SQRT(DK1)
      IF(YPLN1 .LE. 11.63) GO TO 511
      DITM=DEN1*CMU1*SQRTK*ALOG(E*YPLN1)/(CK*YP)
      GO TO 512
 511  DITM=DEN1*CMU1*SQRTK*YPLN1/YP
 512  CONTINUE
      DDU=U0-U1
      DDV=V0-V1
      DDW=W0-W1
      ...
      DDV=V2-V1
      DDW=W2-W1
      P2=DDU**2+DDV**2+DDW**2
      YP2=2*YP1-YP
      GENR=GEN1-VISE1*P2/YP2/YP2
      IF(GENR .LE. 0.0) GENR=0.0
      SU1=TJ01*(SUK1*DK1+(P1*TAUN1**2/VISE1+GENR))
      SP1=TJ01*(SPK1-DITM)
      AN1=0.0
      RETURN
 6    CONTINUE
